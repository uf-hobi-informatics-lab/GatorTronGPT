...
import sys
sys.path.append("/red/gatortron-phi/gpt/Megatron-LM-2022")
sys.path.append("/red/gatortron-phi/gpt/Megatron-LM-2022/megatron")
# sys.path.append("/red/gatortron-phi/gpt/python-ftfy")
# sys.path.append("/red/gatortron-phi/gpt/python-ftfy/ftfy")
...
def main():
    ...
    for samples in tqdm(condition_samples):
        try:
            ...
            resp_sentences = [line.replace("<|endoftext|>", "") for line in resp_sentences]
