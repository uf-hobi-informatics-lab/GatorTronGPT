...
#SBATCH --output=/red/gatortron-phi/gpt/logs/gpt_training_uf_deid_thepile_mimic_20b/gpt_20b_%j.out
#SBATCH --partition=gpu
#SBATCH --reservation=syngatortron
##SBATCH --exclusive
#SBATCH --exclude=c1101a-s29,c0906a-s29,c1009a-s23  #c1010a-s23 c1109a-s23, ,c0800a-s11,c1004a-s23
##SBATCH --exclude=c1109a-s23,c1101a-s29,c0906a-s29,c1004a-s23,c0800a-s11  #c1010a-s23
...
SAMPLE_PER_EPOCH=400000000   #262789535  # modify here
...
BERT_ARGS="--num-layers $L \
    ...
    --tensorboard-dir /red/gatortron-phi/gpt/logs/gpt_training_uf_deid_thepile_mimic_20b \
    --fp16"
